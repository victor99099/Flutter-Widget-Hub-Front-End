...
class UserWidgetBox extends StatelessWidget {
  final int widgetId;
  final String Heading;
  final String code;
  final Widget widget;
...
class UserStyleBox extends StatelessWidget {
  final String Heading;
  final String code;
  const UserStyleBox({
    super.key,
...
class StyleCode extends StatefulWidget {
  final String code;
  const StyleCode({super.key, required this.code});

  @override
  State<StyleCode> createState() => _StyleCodeState();
}

class _StyleCodeState extends State<StyleCode> {
  @override
  Widget build(BuildContext context) {
    return Container(
...
class WidgetCodeAndPreview extends StatefulWidget {
  final String code;
  final int widgetId;
  final Widget widget;
  const WidgetCodeAndPreview({
    super.key,
    required this.code,
    required this.widget,
    required this.widgetId,
  ...
  @override
  State<WidgetCodeAndPreview> createState() => _WidgetCodeAndPreviewState();
}

class _WidgetCodeAndPreviewState extends State<WidgetCodeAndPreview> {
  bool isCodeView = true;
  @override
  Widget build(BuildContext context) {
    return Container(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  await Get.find<ProjectController>()
                                      .deleteWidget(widget.widgetId, context);
                                  // isSaved.value
                                  //     ? null
                                  //     :
                                },
